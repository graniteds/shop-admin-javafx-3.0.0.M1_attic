...
public class Main extends Application {
    ...
    public static class Config {
    	...
    	public ServerSession serverSession() throws Exception {
    		ServerSession serverSession = new ServerSession("spring", "/shop-admin-javafx", "localhost", 8080);
    		serverSession.setUseWebSocket(true);
        	serverSession.addRemoteClassPackage("com.wineshop.client.entities");
    	...
    	@Bean
    	public PagedQuery<Vineyard, Vineyard> vineyards(ServerSession serverSession) throws Exception {
